<template>
  <q-page>
    <font size="1" class="text-bold" color="grey">MASTER DATA / AMPLIFIER CODE</font>
     <div align="left" style="margin-bottom:30px; margin-top:20px;width:200px">
      <font size="5" class="text-bold" style="margin-bottom: 10px">AMPLIFIER CODE</font>
...
<script src="./js/amplifierCode.js"></script>
